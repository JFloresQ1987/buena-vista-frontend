...
@Component({
  selector: 'app-libro-diario-egresos',
  templateUrl: './libro-diario-egresos.component.html',
  styleUrls: ['./libro-diario-egresos.component.css']
})
export class LibroDiarioEgresosComponent implements OnInit {
  ...
  listarRecibos(desde: number) {
    ...
    this.service.listarLibroDiario('egreso', desde)
      // .pipe(
      //   delay(100)
      // )
      .subscribe((res: any) => {
